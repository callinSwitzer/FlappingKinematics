...
# plot partial residuals with base R plotting
arcLenDF <- data.frame(deltaLoad = newDF$dLoad_nonCent, partialResid_deltaFreq = y)
plot(arcLenDF)

# write file for partial residuals
write_csv(x = arcLenDF, 
          file.path(dataOut, 
                    "PartialResiduals_deltaArcLen.csv"))
...
# means we can't evaluate interactions very accurately
car::vif(m1) 
...
write_csv(x = freqDF, 
          file.path(dataOut, 
                    "PartialResiduals_deltaFreq2.csv"))
...
write_csv(partialMetRateDF, 
          file.path(dataOut, "PartialResid_MetRate.csv"))
...
write_csv(predDF_small, file.path(dataOut, "PredictedLine_Fig6b.csv"))
...
write_csv(newDF_6b, file.path(dataOut, "dataPoints_Fig6b.csv"))
